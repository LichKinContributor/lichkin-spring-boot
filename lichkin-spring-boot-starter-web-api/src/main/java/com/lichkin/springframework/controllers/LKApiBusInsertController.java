...
public abstract class LKApiBusInsertController<I extends LKRequestBean, E extends I_Base> extends LKApiVVController<I, I> implements OperLogController<I> {
	...
	public LKApiBusInsertController() {
		super();
	...
	public LKResponseBean<Void> invoke(@Valid @RequestBody I cin) throws LKException {
		...
		if (logService != null) {
			logService.logAdd(cin, (LKRequestInfo) request.getAttribute("requestInfo"), LKOperTypeEnum.ADD + "_" + classE.getSimpleName().replace("Entity", "") + getSubOperBusType(cin));
		}
		return responseBean;
	}
	...
	@Override
	protected abstract LKApiBusInsertService<I, E> getService(I cin);
