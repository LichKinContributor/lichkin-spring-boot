 ...
 */
public abstract class LKApiV0Controller<CI extends LKRequestBean> extends LKApiController<CI, Void> implements ApiController {
	...
	@Override
	protected Void handleInvoke(@Valid CI cin) throws LKException {
		doInvoke(cin);
		return null;
	}
