 ...
 */
@LKController4Api
public abstract class LKApiBusUpdateController<I extends LKRequestInterface, SI extends I_ID, E extends I_Base> extends LKVoidServiceApiController<I, LKResponseBlankBean, SI> {
